...
<html>
    <head>
        ...
        <title>My Account - <?php echo $title; ?></title>
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo base_url('dashboard.html'); ?>" class="logo">
                    ...
                    <span class="logo-lg"><b>Studybrate | Admin</b></span>
                </a>
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; 2019 <a href="https://doctotcloud.in" target="_blank">Studybrate</a>.</strong> All rights reserved - Developed by DrCloud Pvt. Ltd.
            </footer>
