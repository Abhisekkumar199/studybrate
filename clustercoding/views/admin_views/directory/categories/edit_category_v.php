...
<section class="content">
    <div class="box box-success">
        ...
        <!-- form start -->
        <form role="form" name="category_edit_form" action="<?php echo base_url('admin/directory/categories/update_category/' . $category_info['category_id'] . '.html'); ?>" method="post" enctype="multipart/form-data">
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php
                            $avatar = $category_info['category_image'];
                            if (!empty($avatar)) 
                            {
