...
<section class="content">
    <div class="box box-success">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-6" >
                    <a href="<?php echo base_url('directory/categories/add_category.html?parent='.$parentcategory); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Category </a>
                </div>
                <div class="col-md-6" >
                    <form role="form" name="category_add_form" action="<?php echo base_url('admin/directory/categories'); ?>" method="get">
                     
                    <select name="parent" class="btn btn-success form-control custom-select categoryfilter pull-right"style="width: 100px;"  onchange="this.form.submit()" >
                        ...
                        <tbody>
                            ...
                            <?php foreach ($categories_info as $v_category_info) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $avatar = $v_category_info['category_image'];
                                        if (!empty($avatar)) 
                                        {
