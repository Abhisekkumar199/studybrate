                        ...
                        <tbody>
                            ...
                            <?php foreach ($listing_info as $v_listing_info) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $v_listing_info['password']; ?></td>
                                    <td><?php echo $v_listing_info['category_name']; ?></td>
                                    <td><?php echo $v_listing_info['paid_status']; ?></td>
                                    <td><?php   if($v_listing_info['expire_date'] != '0000-00-00' ) { echo $v_listing_info['expire_date']; } ?></td>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('directory/listing/reviews/' . $v_listing_info['listing_id'] . '.html') ?>" class="btn btn-block btn-success btn-xs" data-toggle="tooltip" ><i class="fa fa-arrow-down"></i> Reviews</a>
                                        <a href="<?php echo base_url('directory/listing/paidstatus/' . $v_listing_info['listing_id'] . '.html') ?>" class="btn btn-block btn-success btn-xs" data-toggle="tooltip" ><i class="fa fa-arrow-down"></i> Paid Status</a>
