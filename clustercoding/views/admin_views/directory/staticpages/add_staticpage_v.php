...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a class="active"><i class="fa fa-cogs"></i> Add Static Page</a></li>
    </ol>
</section>
...
<section class="content">
    <div class="box box-success">
        ...
        <!-- form start -->
        <form role="form" name="category_add_form" action="<?php echo base_url('admin/directory/staticpages/create_staticpage.html'); ?>" method="post">
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="page_title" value="<?php echo set_value('page_title'); ?>" class="form-control" id="page_title" placeholder="Enter Page Title">
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" id="description" placeholder="Enter category description" rows="10"><?php echo set_value('description'); ?></textarea>
