...
<html>
    <head>
        ...
        <title>Studybrate <?php echo $title; ?></title>
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="<?php echo base_url('cms.html'); ?>"><b>studybrate </b>Admin</a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                ...
                if (!empty($success)) {
                    ...
                    <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                    <span><i class='icon fa fa-warning'></i> Sign in to start your session.</span>
                </div>";
                }
                ?>
                ...
                <!-- /.social-auth-links -->
                <hr>
                <a href="<?php echo base_url('user/login/forgot_password.html'); ?>">I forgot my password</a><br>
