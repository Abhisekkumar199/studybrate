                                        ...
                                        <?php foreach ($recent_articles as $v_recent_article) { ?>
                                            <div class="item col-md-4 col-sm-6 col-xs-12"><!-- .ITEM -->
                                                <div class="listing-item clearfix">
                                                    <div class="figure">
                                                        <img src="<?php echo base_url('assets/uploaded_files/company_articles/' . $v_recent_article['image_path']); ?>" width="270" alt="<?php echo $v_recent_article['article_name']; ?>"/>
                                    ...
                                    <div class="listing-wrapper three-column row">
                                        ...
                                        <?php foreach ($popular_articles as $v_popular_article) { ?>
                                            <div class="item col-md-4 col-sm-6 col-xs-12"><!-- .ITEM -->
                                                <div class="listing-item clearfix">
                                                    <div class="figure">
                                                        <img src="<?php echo base_url('assets/uploaded_files/company_articles/' . $v_popular_article['image_path']); ?>" width="270" alt="<?php echo $v_popular_article['article_name']; ?>"/>
                                                        <div class="listing-overlay">
                                                            <div class="listing-overlay-inner rgba-bgorange-1">
                                                                <div class="overlay-content">
                                                                    <ul class="listing-links">
                                        ...
                                        <div class="row" id="load_data">
                                            <?php foreach ($all_articles as $v_article) { ?>
                                                <div class="item col-md-4 col-sm-6 col-xs-12"><!-- .ITEM -->
                                                    <div class="listing-item clearfix">
                                                        <div class="figure">
                                                            <img src="<?php echo base_url('assets/uploaded_files/company_articles/' . $v_article['image_path']); ?>" width="270" alt="<?php echo $v_article['article_name']; ?>"/>
                                                            <div class="listing-overlay">
                                                                <div class="listing-overlay-inner rgba-bgorange-1">
                                                                    <div class="overlay-content">
                                                                        <ul class="listing-links">
