...
<div class="container margin_60_35">
  <div class="row">
          ...
          <div class="filter_type">
            ...
            <ul>
                ...
                foreach ($child_categories as $v_category_info) {
                    echo "<li><label class='container_check'><a  href='" . base_url('institutes_listing/category_listing/' . $v_category_info['category_id']."-".$current_category . '.html') . "'><i class='fa fa-".$v_category_info['icon_name']." ".$v_category_info['color_name']." white'></i>" . $v_category_info['category_name'] . "<span class='checkmark'></span></a></label></li>";
                }
                ?>
            </ul>
          </div>
          ...
          <div class="filter_type">
            ...
            <ul>
                ...
                foreach ($cities_info as $v_city_info) {
                    echo "<li><a class='nohover' href='" . base_url('institutes_listing/location_listing/' . $v_city_info['city_id']."-".$current_category . '.html') . "'><i class='fa fa-map-marker blue-1'></i>" . $v_city_info['city_name'] . "</a></li>";
                }
                ?>
            </ul>
          </div>
    ...
    <div class="col-lg-9">
        ...
        <div class="col-md-6">
          <div class="strip grid">
            ...
            <ul>
              ...
              <li><div class="score"><span>Superb<em>50 Reviews</em></span><strong>8.9</strong></div></li>
            </ul>
          </div>
        </div>
      ...
      <div id="remove_row">
          <center>
              <button type="button" name="btn_more" data-id="<?php if(isset($listing_id)){ echo $listing_id; } ?>" data-cid="" data-link="institutes_listing/load_more_listing" id="btn_more" class="btn btn-sm bgbrown-1">Load more...</button>
          </center>
      </div>
    </div>
    <!-- /col -->
