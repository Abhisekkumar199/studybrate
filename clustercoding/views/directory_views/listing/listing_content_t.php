...
<div class="container margin_60_35">
  <div class="row">
    ...
    <div class="col-lg-9">
        ...
        <div class="col-md-6">
          <div class="strip grid">
            ...
            <div class="wrapper">
              ...
              <p><?php echo $character = character_limiter($v_listing_info['about_company'], 105);   ?></p>
              <a class="" href=""> Education : <?php echo $v_listing_info['subjects'] ; ?></a><br>
              <a class="" href=""> Subjects : <?php echo $v_listing_info['education'] ; ?></a><br>
              <a class="" href=""> (<?php echo $v_listing_info['registration_code'].') Years of Experiance' ; ?></a>
            </div>
            <ul>
      ...
      <div id="remove_row">
          <center>
              <button type="button" name="btn_more" data-id="<?php echo $listing_id; ?>" data-cid="" data-link="teachers_listing/load_more_listing" id="btn_more" class="btn btn-sm bgbrown-1">Load more...</button>
          </center>
      </div>
    </div>
    <!-- /col -->
