            ...
            <div class="add-listing-nav shadow-1">
                <div class="row clearfix">
                    <div class="col-md-9 col-sm-9 col-xs-9 pull-left">
                        <a href="<?php echo base_url('user/notes/add_notes.html'); ?>" class="btn bgorange-1 add-btn"><i class="fa fa-plus"></i> Add note</a>
                    </div>
            ...
            <div class="listing-main gridview tab-content padding-top-30">
                <div id="latest-listing" class="tab-pane active">
                    <div class="listing-wrapper three-column row">
                        ...
                        <?php foreach ($notes_info as $v_note_info) { ?>
                            <div class="item col-md-4 col-sm-6 col-xs-12"><!-- .ITEM -->
                                <div class="listing-item clearfix">
                                    <div class="figure"> 
                                        <img src="https://studybrate.com/img/notes.jpg" width="270" alt="listing item">
                                        <div class="listing-overlay">
                                            <div class="listing-overlay-inner rgba-bgorange-1">
                                                <div class="overlay-content">
                                                    <ul class="listing-links">
                                                        <li><a class="bgwhite nohover" href="<?php echo base_url('notes/note_details/' . $v_note_info['note_id'] . '.html'); ?>"><i class="fa fa-search green-1 "></i></a></li>
                                                        <li><a class="bgwhite nohover" href="<?php echo base_url('user/notes/edit_note/' . $v_note_info['note_id'] . '.html'); ?>"><i class="fa fa-edit green-1 "></i></a></li>
                                                        <li><a class="bgwhite nohover" href="<?php echo base_url('user/notes/remove_note/' . $v_note_info['note_id'] . '.html'); ?>"><i class="fa fa-trash blue-1"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="listing-content clearfix">
                                        ...
                                        <div class="listing-title">
                                            <h6><a href="<?php echo base_url('notes/note_details/' . $v_note_info['note_id'] . '.html'); ?>"><?php echo character_limiter($v_note_info['note_name'], 15); ?></a></h6>
                                        </div>
                                        <div class="listing-disc">
                                            <p><?php echo character_limiter($v_note_info['note_details'], 250); ?></p>
                                        </div>
                                        <div class="listing-location pull-left"><!-- location-->
                                            <a><i class="fa fa-briefcase"></i> <?php echo character_limiter($v_note_info['company_name'], 24); ?></a>
