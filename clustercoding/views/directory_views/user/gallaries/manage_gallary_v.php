            ...
            <div class="add-listing-nav shadow-1">
                <div class="row clearfix">
                    <div class="col-md-9 col-sm-9 col-xs-9 pull-left">
                        <a href="<?php echo base_url('user/gallaries/add_gallary.html'); ?>" class="btn bgorange-1 add-btn"><i class="fa fa-plus"></i> Add gallary</a>
                    </div>
            ...
            <div class="listing-main gridview tab-content padding-top-30">
                <div id="latest-listing" class="tab-pane active">
                    <div class="listing-wrapper three-column row">
                        ...
                        <?php foreach ($gallary_info as $v_gallary_info) { ?>
                            <div class="item col-md-4 col-sm-6 col-xs-12"><!-- .ITEM -->
                                <div class="listing-item clearfix">
                                    <div class="figure">
                                        <img src="<?php echo base_url('assets/uploaded_files/company_gallary/' . $v_gallary_info['image_path']); ?>" width="270" alt="listing item"/>
                                        <div class="listing-overlay">
                                            <div class="listing-overlay-inner rgba-bgorange-1">
                                                <div class="overlay-content">
                                                    <ul class="listing-links">
                                                        <li><a class="bgwhite nohover" href="<?php echo base_url('user/gallaries/edit_gallary/' . $v_gallary_info['gallary_id'] . '.html'); ?>"><i class="fa fa-edit green-1 "></i></a></li>
                                                        <li><a class="bgwhite nohover" href="<?php echo base_url('user/gallaries/remove_gallary/' . $v_gallary_info['gallary_id'] . '.html'); ?>"><i class="fa fa-trash blue-1"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="listing-content clearfix">
                                        ...
                                        <div class="listing-title">
                                            <h6><a href="<?php echo base_url('gallary/gallary_details/' . $v_gallary_info['gallary_id'] . '.html'); ?>"><?php echo character_limiter($v_gallary_info['gallary_name'], 15); ?></a></h6>
                                        </div>
                                        <div class="listing-disc">
                                            <p><?php echo character_limiter($v_gallary_info['gallary_details'], 250); ?></p>
                                        </div>
                                        <div class="listing-location pull-left"><!-- location-->
                                            <a><i class="fa fa-briefcase"></i> <?php echo character_limiter($v_gallary_info['company_name'], 24); ?></a>
