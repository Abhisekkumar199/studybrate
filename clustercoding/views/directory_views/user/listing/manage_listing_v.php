...
<div class="row content-title">
    <div class="col-md-6 col-sm-6 col-xs-6">
        <h6 class="pull-left"> Manage Institute/Teachers Profiles</h6>
    </div>
    <div class="col-md-6 col-sm-6 col-xs-6">
        <ul class="list-inline pull-right">
            <li><a href="<?php echo base_url('user/listing.html'); ?>"><i class="fa fa-home black"></i>My Dashboard</a></li> >
            <li><a class="active"> Manage Institute/Teachers Profiles</a></li>
        </ul>
    </div>
</div>
            ...
            <div class="add-listing-nav shadow-1">
                <div class="row clearfix">
                    <div class="col-md-9 col-sm-9 col-xs-9 pull-left">
                        <a href="<?php echo base_url('user/listing/add_listing.html'); ?>" class="btn bgbrown-1 add-btn"><i class="fa fa-plus"></i> Add Institute/Teachers Profiles</a>
                    </div>
                            ...
                            <div class="item col-md-4 col-sm-6 col-xs-12"><!-- .ITEM -->
                                <div class="listing-item clearfix">
                                    <div class="figure">
                                        ...
                                        ?>
                                        <img src="<?php echo base_url($company_logo); ?>" width="270" style="height: 200px !important;" alt="<?php echo $v_listing_info['company_name']; ?>" class="img-responsive"/>

                                        <div class="listing-overlay">
                                            <div class="listing-overlay-inner bgbrown-1">
                                                <div class="overlay-content">
                                                    <ul class="listing-links">
                                                        <li><a class="bgwhite nohover" href="<?php if($v_listing_info['type']==1){ echo base_url('institutes_listing/listing_details/' . $v_listing_info['listing_id'] . '.html');}else {
                                                          echo base_url('teachers_listing/teacher_details/' . $v_listing_info['listing_id'] . '.html');
                                                        } ?>"><i class="fa fa-search green-1 "></i></a></li>
                                    ...
                                    <div class="listing-content clearfix">
                                        ...
                                        <div class="listing-title">
                                            <h6><a href="<?php if($v_listing_info['type']==1){echo base_url('listing/listing_details/' . $v_listing_info['listing_id'] . '.html');} ?>"><?php echo $v_listing_info['company_name']; ?></a></h6>
                                        </div>
