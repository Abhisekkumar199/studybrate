...
<div class="row content-title">
    <div class="col-md-6 col-sm-6 col-xs-6">
        <h6 class="pull-left"> Add blog</h6>
    </div>
    <div class="col-md-6 col-sm-6 col-xs-6">
        <ul class="list-inline pull-right">
            ...
            <li><a class="active"> Add blog</a></li>
        </ul>
    </div>
</div>
...
<div class="row manage-container">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        if (1) {
            ?>
            <form name="add_blog_form" class="custom-form" action="<?php echo base_url('user/blogs/store_blog_details.html'); ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="blog_name">Title <span class="required-field">*</span></label>
                            <input type="text" name="blog_name" value="<?php echo set_value('blog_name'); ?>" class="form-control margin-top-5" id="blog_name" placeholder="Enter blog Title">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <textarea rows="4" name="blog_details" class="form-control margin-top-5" id="blog_details" placeholder="Enter blog contents"><?php echo set_value('blog_details'); ?></textarea>
