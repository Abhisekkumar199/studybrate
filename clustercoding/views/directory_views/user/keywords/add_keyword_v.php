...
<div class="row content-title">
    <div class="col-md-6 col-sm-6 col-xs-6">
        <h6 class="pull-left"> Add Keywords</h6>
    </div>
    <div class="col-md-6 col-sm-6 col-xs-6">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="keyword_name" value="<?php echo set_value('keyword_name'); ?>" class="form-control margin-top-5" id="keyword_name" placeholder="Enter Keyword Name ...">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="listing_id">Select Profile Name <span class="required-field">*</span></label>
