...
<div class="row content-title">
    <div class="col-md-6 col-sm-6 col-xs-6">
        <h6 class="pull-left"> Edit Article</h6>
    </div>
    <div class="col-md-6 col-sm-6 col-xs-6">
        <ul class="list-inline pull-right">
            ...
            <li><a class="active"> Edit Article</a></li>
        </ul>
    </div>
</div>
...
<div class="row manage-container">
    <div class="col-md-12 col-sm-12 col-xs-12 padding-top-10">
        ...
        <form name="edit_article_form" class="custom-form" action="<?php echo base_url('user/articles/update_article_details/' . $article_info['article_id'] . '.html'); ?>" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group custom-group">
                        <label for="article_name">Title <span class="required-field">*</span></label>
                        <input type="text" name="article_name" value="<?php echo $article_info['article_name']; ?>" class="form-control margin-top-5" id="article_name" placeholder="Enter company name">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <textarea rows="4" name="article_details" class="form-control margin-top-5" id="article_details" placeholder="Enter article details"><?php echo $article_info['article_details']; ?></textarea>
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="form-group">
                        <input name="current_picture" type="hidden" value="<?php echo $article_info['image_path']; ?>">
                        <img src="<?php echo base_url('assets/uploaded_files/company_articles/' . $article_info['image_path']); ?>" width="80" alt="<?php echo $article_info['image_path']; ?>">
                    </div>
                </div>
                <!-- End Col -->
                <div class="col-md-12 col-sm-12 col-xs-12">
...
<script type="text/javascript">
    document.forms['edit_article_form'].elements['listing_id'].value = '<?php echo $article_info['listing_id']; ?>';
</script>