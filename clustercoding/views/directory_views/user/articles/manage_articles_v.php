...
<div class="row content-title">
    <div class="col-md-6 col-sm-6 col-xs-6">
        <h6 class="pull-left"> Manage Articles</h6>
    </div>
    <div class="col-md-6 col-sm-6 col-xs-6">
            ...
            <div class="add-listing-nav shadow-1">
                <div class="row clearfix">
                    <div class="col-md-9 col-sm-9 col-xs-9 pull-left">
                        <a href="<?php echo base_url('user/articles/add_article.html'); ?>" class="btn bgorange-1 add-btn"><i class="fa fa-plus"></i> Add Article</a>
                    </div>
                        ...
                        <?php foreach ($articles_info as $v_article_info) { ?>
                            <div class="item col-md-4 col-sm-6 col-xs-12"><!-- .ITEM -->
                                <div class="listing-item clearfix">
                                    <div class="figure">
                                        <img src="<?php echo base_url('assets/uploaded_files/company_articles/' . $v_article_info['image_path']); ?>" width="270" alt="listing item"/>
                                            ...
                                            <div class="listing-overlay-inner rgba-bgorange-1">
                                                <div class="overlay-content">
                                                    <ul class="listing-links">
                                                        ...
                                                        <li><a class="bgwhite nohover" href="<?php echo base_url('user/articles/edit_article/' . $v_article_info['article_id'] . '.html'); ?>"><i class="fa fa-edit green-1 "></i></a></li>
                                                        <li><a class="bgwhite nohover" href="<?php echo base_url('user/articles/remove_article/' . $v_article_info['article_id'] . '.html'); ?>"><i class="fa fa-trash blue-1"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="listing-content clearfix">
                                        ...
                                        <div class="listing-disc">
                                            <p><?php echo character_limiter($v_article_info['article_details'], 250); ?></p>
                                        </div>
                                        <div class="listing-location pull-left"><!-- location-->
                                            <a><i class="fa fa-briefcase"></i> <?php echo character_limiter($v_article_info['company_name'], 24); ?></a>
