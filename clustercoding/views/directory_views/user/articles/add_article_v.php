                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="article_name" value="<?php echo set_value('article_name'); ?>" class="form-control margin-top-5" id="article_name" placeholder="Enter Article Title">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <textarea rows="4" name="article_details" class="form-control margin-top-5" id="article_details" placeholder="Enter article contents"><?php echo set_value('article_details'); ?></textarea>
