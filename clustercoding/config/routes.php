...
$route['ajax-get-adminchildcategory/(:any)'] = 'admin/directory/categories/get_child_category/$i'; 


$route['send-mobile-otp/(:any)'] = "user/registration/send_otp/$1";
$route['ajax-get-childcategory/(:any)'] = 'user/categories/get_child_category/$i'; 
$route['ajax-get-subject/(:any)'] = 'user/subjects/get_subject_list/$i'; 
$route['search/(:any)'] = "search/search_result_category_wise/$1"; 

$route['tutors'] = "search/tutorFilter"; 
$route['user-question'] = "user/questions/store_question_details"; 


$route['teachers'] = "search/search_result"; 
$route['subject/(:any)'] = "search/search_result_subject_wise/$1"; 
$route['pages/(:any)'] = "Staticpages/index/$1"; 
...
$route['directory/categories/(:any)'] = 'admin/directory/categories/index/$i'; 



 
// Start Directory Subject
$route['directory/subjects'] = "admin/directory/subjects/index"; 
$route['directory/subjects/add_subject'] = "admin/directory/subjects/add_subject"; 
$route['directory/subjects/edit_subject/(:any)'] = "admin/directory/subjects/edit_subject/$1"; 

// Start Directory Static Pages
$route['directory/staticpages'] = "admin/directory/staticpages/index"; 
$route['directory/staticpages/add_staticpage'] = "admin/directory/staticpages/add_staticpage"; 
$route['directory/staticpages/edit_staticpage/(:any)'] = "admin/directory/staticpages/edit_staticpage/$1";
...
$route['directory/listing/paidstatus/(:any)'] = "admin/directory/paidstatus/index/$1"; ;
$route['directory/listing/update-paidstatus/process'] = "admin/directory/paidstatus/update_status";
...
$route['directory/listing/reviews/(:any)'] = "admin/directory/reviews/index/$1";
$route['directory/listing/reviews/published/(:any)'] = "admin/directory/reviews/published_review/$1";
$route['directory/listing/reviews/unpublished/(:any)'] = "admin/directory/reviews/unpublished_review/$1";
$route['directory/listing/reviews/remove/(:any)'] = "admin/directory/reviews/remove_image/$1";
$route['directory/listing/reviews/reply/(:any)'] = "admin/directory/reviews/reply/$1"; 


$route['directory/listing/career-councelling'] = "admin/directory/career_counselling/index";
