...
class Login extends CC_Controller {
    ...
    public function index() 
    {
        ...
        $data['main_content'] = $this->load->view('directory_views/user/login/user_login', $data, TRUE);
    ...
    public function forgot_password() {
        ...
        $data['header_menu'] = $this->cat_mdl->headerMenu(); 
        $data['static_pages'] = $this->home_mdl->static_pages();
        $data['main_content'] = $this->load->view('directory_views/user/login/forgot_password', $data, TRUE);
        $this->load->view('directory_views/user_master_inner', $data);
    }
