...
class institutes_listing extends CC_Controller {
    ...
    public function index() 
    {
        ...
        $data['main_content'] = $this->load->view('directory_views/listing/listing_content', $data, TRUE);
    ...
    public function location_listing($city_id = NULL) 
    {
        ...
        $data['current_category'] = $parent_category;
        $data['child_categories'] = $this->cat_mdl->get_child_categories_list($parent_category);
        $data['all_listing'] = $this->list_mdl->get_city_info_by_city_id($city_id);
        if (!empty($data['all_listing'])) {
            $data['title'] = 'Listing by Category';
    ...
    public function listing_details($listing_id = NULL) 
    {
        ...
        if (!empty($data['listing_info'])) {
            ...
            $data['main_content'] = $this->load->view('directory_views/listing/institute_details', $data, TRUE);
            $this->load->view('directory_views/user_master_inner', $data);
        } else {
            redirect();
        }
