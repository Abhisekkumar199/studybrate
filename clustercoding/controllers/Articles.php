...
class Articles extends CC_Controller {
            ...
            foreach ($articles_info as $v_article_info) {
                ...
                <div class="item col-md-4 col-sm-6 col-xs-12"><!-- .ITEM -->
                    <div class="listing-item clearfix">
                        <div class="figure">
                            <img src="' . base_url('assets/uploaded_files/company_articles/' . $v_article_info['image_path']) . '" width="270" alt="' . $v_article_info['article_name'] . '"/>
    ...
    public function article_details($article_id = NULL) {
        ...
        if (!empty($data['article_info'])) 
        {
            ...
            $data['main_content'] = $this->load->view('directory_views/articles/article_details', $data, TRUE);
