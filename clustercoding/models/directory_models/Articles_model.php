...
class Articles_model extends CC_Model {
    ...
    public function get_recent_articles() {
        $this->db->select('articles.*, cat.category_name, cities.city_name, listing.company_name, listing.education, listing.state, listing.address, listing.zip')
    ...
    public function get_article_info_by_article_id($article_id) {
        $this->db->select('articles.*, cat.category_name, cities.city_name, listing.listing_id, listing.company_name, listing.education, listing.subjects, listing.experiance, listing.mobile, listing.email, listing.company_logo, listing.state, listing.address, listing.zip')
                ->from('dir_articles as articles')
                ->join('dir_listing as listing', 'articles.listing_id = listing.listing_id','left')
                ->join('dir_cities as cities', 'listing.city_id = cities.city_id','left')
                ->join('dir_categories as cat', 'listing.category_id = cat.category_id','left')
